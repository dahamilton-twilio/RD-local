...
resource "twilio_taskrouter_workspaces_task_queues_v1" "template_example_billing" {
  workspace_sid        = twilio_taskrouter_workspaces_v1.flex.sid
  friendly_name        = "Template Example Billing"
  target_workers       = "routing.skills HAS 'template_example_billing'"
  max_reserved_workers = 1
  task_order           = "FIFO"
}
